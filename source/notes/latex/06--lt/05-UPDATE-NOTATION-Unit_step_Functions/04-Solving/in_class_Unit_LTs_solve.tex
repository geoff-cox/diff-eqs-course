...
\begin{center}
	...
	{\sc Solving DEs with Unit Step Functions via Laplace Transforms}
\end{center}
\vspace{-0.5cm}
\noindent\rule{7in}{0.4pt}
...
\noindent  The current $i(t)$ in an LC series circuit is governed by the initial value problem
\[
	i^{\,\prime\prime}(t) + 4i(t) = g(t), \quad i(0) = 0, \quad i^{\,\prime}(0) = 0,
\]
where
\[ 
	g(t) = \left\{
